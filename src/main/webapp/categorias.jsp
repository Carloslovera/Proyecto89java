...
<body>
  ...
  <header>
    ...
    <div class="row row-cols-md-4 w-100">
      <div class="card w-5%" >
        <img src="./img/zapatos/ADIDAS5.webp" class="card-img-top" alt="...">
        <div class="card-body">
      ...
      <div class="card w-25%" >
        <img src="./img/zapatos/ADIDAS6.webp" class="card-img-top" alt="...">
        <div class="card-body">
          <div class="d-grid gap-2 col-6 mx-auto">
            <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
            </div>
      ...
      <div class="card w-25%" >
        <img src="./img/zapatos/adidas4.webp" class="card-img-top" alt="...">
        <div class="card-body">
          <div class="d-grid gap-2 col-6 mx-auto">
            <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
            </div>
      ...
      <div class="card w-25%" >
        <img src="./img/zapatos/NIKE7.webp" class="card-img-top" alt="...">
        <div class="card-body">
          <div class="d-grid gap-2 col-6 mx-auto">
            <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
            </div>
      ...
      <div class="card w-25%" >
        <img src="./img/zapatos/NIKE6.webp" class="card-img-top" alt="...">
        <div class="card-body">
          <div class="d-grid gap-2 col-6 mx-auto">
            <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
            </div>
      ...
      <div class="card w-25%" >
        <img src="./img/zapatos/nike9.webp" class="card-img-top" alt="...">
        <div class="card-body">
          <div class="d-grid gap-2 col-6 mx-auto">
            <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
            </div>
      ...
      <div class="card w-25%" >
        <img src="./img/zapatos/nike8.webp" class="card-img-top" alt="...">
        <div class="card-body">
          <div class="d-grid gap-2 col-6 mx-auto">
            <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
            </div>
    ...
    <div class="row row-cols-md-4 w-100">
        ...
        <div class="card w-25%" >
          <img src="./img/camperas y buzos/adidas2.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/camperas y buzos/adidas3.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/camperas y buzos/adidas4.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/camperas y buzos/nike5.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/camperas y buzos/nike2.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/camperas y buzos/nike3.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/camperas y buzos/nike4.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
    ...
    <div class="row row-cols-md-4 w-100">
      ...
      <!-- Fin de Cards Pantalones -->

      <!-- Cards Remeras  -->
    <div class="row row-cols-md-4 w-100">
        <div class="card w-5%" >
          <img src="./img/remeras/nike1.1.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/remeras/nike2.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/remeras/nike3.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/remeras/nike4.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/remeras/adidas3.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/remeras/adidas4.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
        ...
        <div class="card w-25%" >
          <img src="./img/remeras/adidas5.webp" class="card-img-top" alt="...">
          <div class="card-body">
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="button" class="btn btn-outline-secondary"><a href="./carrito.jsp">Comprar</button></a>
              </div>
