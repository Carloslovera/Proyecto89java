		    ...
		    <div class="form-row"><!-- INICIO Localidad y Ciudad -->
		      <div class="col-md-6 mb-3">
		        ...
		        <div class="invalid-feedback">
		          Favor de indicar un Barrio válido.
		        </div>
		      </div>
		      <div class="col-md-3 mb-3">
		        ...
		        <select class="custom-select" id="ciudad" required>
		          ...
		          <option>Salta</option>
		          <option disabled value="">Muchos más por venir...</option>
		        </select>
		        <div class="invalid-feedback">
		          Favor de seleccionar una Ciudad válida.
		        </div>
		      </div>
		      <div class="col-md-3 mb-3">
		        ...
		        <div class="invalid-feedback">
		          Favor de indicar Código Postal válido.
		        </div>
		      </div>
		    ...
		    <div class="form-group">
		      <div class="form-check">
		        ...
		        <label class="form-check-label" for="invalidCheck">
		          Tilde la casilla para aceptar nuestros <span class="font-weight-bold"><a href="#">Términos y Condiciones</a></span>. <!-- No sé si conviene con un span, o directo al link ponerle la clase bold -->
		        </label>
		        <div class="invalid-feedback">
		          Para continuar, deberás aceptar nuestros Términos y Condiciones. Gracias!
		        </div>
		      </div>
		    </div>
